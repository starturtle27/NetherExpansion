...
{
    public static ItemStack getBlockItemStack(final String string) {
        final Optional<? extends Block> stackblock = EnumBlocks.valueOf(string).block;
        final int stackmeta = EnumBlocks.valueOf(string).meta;
        if (stackmeta != 0) {
            return new ItemStack((Block)stackblock.get(), 1, stackmeta);
        }
        return new ItemStack((Block)stackblock.get(), 1);
    }
    
    public static int getBlockID(final String string) {
        final Optional<? extends Block> stackblock = EnumBlocks.valueOf(string).block;
        return ((Block)stackblock.get()).blockID;
    }
    
    public static int getBlockMeta(final String string) {
        final int stackmeta = EnumBlocks.valueOf(string).meta;
        return stackmeta;
    }
    ...
    public enum EnumBlocks
    {
        ...
        private EnumBlocks(final Optional<? extends Block> block, final int meta) {
            this.block = block;
            this.meta = meta;
        }
