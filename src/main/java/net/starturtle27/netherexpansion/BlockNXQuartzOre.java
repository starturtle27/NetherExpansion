...
public class BlockNXQuartzOre extends BlockOre
{
    int amountMined;
    Random rand;
    
    public BlockNXQuartzOre(final int par1) {
        super(par1);
        this.amountMined = 0;
    ...
    public void harvestBlock(final World par1World, final EntityPlayer par2EntityPlayer, final int par3, final int par4, final int par5, final int par6) {
        ...
        if (NetherX.enableZPigAngryness) {
            if (this.amountMined != 150) {
                ++this.amountMined;
            }
            if (this.rand.nextInt(200) <= this.amountMined) {
                ...
                for (int i = 0; i < list.size(); ++i) {
                    ...
                    if (entity1 instanceof EntityPigZombie) {
                        ...
                        entitypigzombie.angerLevel = 100 + this.rand.nextInt(100);
