...
public class WorldGenDeadTree extends WorldGenerator
{
    ...
    public WorldGenDeadTree(final boolean par1) {
        super(par1);
        this.rand = new Random();
        this.basePos = new int[] { 0, 0, 0 };
        this.heightLimit = 0;
        this.heightAttenuation = 0.45;
        this.branchDensity = 0.25;
        this.branchSlope = 0.2;
        this.scaleWidth = 1.0;
    ...
    void genTreeLayer(final int par1, final int par2, final int par3, final float par4, final byte par5, final int par6) {
        ...
        final byte var8 = WorldGenDeadTree.otherCoordPairs[par5];
        final byte var9 = WorldGenDeadTree.otherCoordPairs[par5 + 3];
    ...
    void placeBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger, final int par3) {
        ...
        if (var4[var6] != 0) {
            final byte var7 = WorldGenDeadTree.otherCoordPairs[var6];
            final byte var8 = WorldGenDeadTree.otherCoordPairs[var6 + 3];
            byte var9;
            if (var4[var6] > 0) {
                var9 = 1;
            }
            ...
            for (int var13 = 0, var14 = var4[var6] + var9; var13 != var14; var13 += var9) {
                ...
                this.setBlockAndMetadata(this.worldObj, var12[0], var12[1], var12[2], par3, (int)var15);
            }
        }
    }
    ...
    void generateTrunk() {
        ...
        this.placeBlockLine(var5, var6, NetherX.vilewood.blockID);
        if (this.trunkSize == 2) {
    ...
    void generateLeafNodeBases() {
        ...
        while (var1 < var2) {
            ...
            if (this.leafNodeNeedsBase(var6)) {
                this.placeBlockLine(var3, var5, NetherX.vilewood.blockID);
            }
            ++var1;
        }
    }
    ...
    int checkBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger) {
        ...
        final byte var6 = WorldGenDeadTree.otherCoordPairs[var5];
        final byte var7 = WorldGenDeadTree.otherCoordPairs[var5 + 3];
        byte var8;
        if (var3[var5] > 0) {
            var8 = 1;
        }
    ...
    boolean validTreeLocation() {
        ...
        if (var3 != Block.netherrack.blockID && var3 != Block.slowSand.blockID) {
            return false;
        }
    ...
    public boolean generate(final World par1World, final Random par2Random, final int par3, final int par4, final int par5) {
        ...
        if (this.heightLimit == 0) {
            this.heightLimit = 8 + par2Random.nextInt(4);
        }
