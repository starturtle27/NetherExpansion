...
{
    public ItemObsidianBoat(final int par1) {
        super(par1);
        this.maxStackSize = 1;
    ...
    public ItemStack onItemRightClick(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer) {
        ...
        final Vec3 vec3 = par2World.getWorldVec3Pool().getVecFromPool(d0, d2, d3);
        ...
        if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE) {
            ...
            final EntityObsidianBoat entityboat = new EntityObsidianBoat(par2World, (double)(i + 0.5f), (double)(j + 1.0f), (double)(k + 0.5f));
