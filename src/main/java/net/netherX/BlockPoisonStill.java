...
public class BlockPoisonStill extends BlockStationary
{
    @SideOnly(Side.CLIENT)
    private static Icon poison;
    
    protected BlockPoisonStill(final int par1, final Material par2Material) {
    ...
    public void registerIcons(final IconRegister par1IconRegister) {
        BlockPoisonStill.poison = par1IconRegister.registerIcon(this.getTextureName());
    }
    
    @SideOnly(Side.CLIENT)
    public static Icon getFluidIcon(final String par0Str) {
        return BlockPoisonStill.poison;
    }
